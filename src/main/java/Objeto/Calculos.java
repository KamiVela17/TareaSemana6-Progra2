...
public class Calculos {
    ...
    public static ArrayList<ClsCalculoMes> list = new ArrayList();
    ...
    public static void cargaInfo(int filas) {
        ...
        for (int x = 0; x < filas; x++) {
            ...
            ClsCalculoMes cls = new ClsCalculoMes(nombre, Integer.parseInt(enero), Integer.parseInt(febrero), Integer.parseInt(marzo), 0, 0);
            list.add(cls);
        }

    }

    public static void imprimirDecorado(ArrayList<ClsCalculoMes> array) {
